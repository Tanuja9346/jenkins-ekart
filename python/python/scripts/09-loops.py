...
# sample_str_list = list(sample_str) --->in list t,h,i,s,like that
...
# #     sample_str += c
# sample_str = "".join(sample_str_list)--->join the string.
# print(sample_str)

# sample_tuple = ('a', 'b', 'c', 'd')--->tuple also get
# for ele in sample_tuple:
#     print(ele)

# sample_tuple_list = [('a', 1), ('b', 2), ('c', 3)]
# for val1, val2 in sample_tuple_list:  --->get a =1 ,b= 2 u can declare a 2 variable
#     print(val1, val2)
...
#         break -->output:terminate the loop and here finding index of element.
#         # continue
#     idx += 1

# enumerate
# sample_list = [10, 10, 20, 30, 5, 80, 90]
# for idx, ele in enumerate(sample_list): --->withnindex it will come 
#     print(idx, ele)
...
# for ele1, ele2 in zip(list1, list2):  output: 1=a,2=b,like that
#     print(ele1, ele2)
